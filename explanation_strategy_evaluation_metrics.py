...
# ### Type of composite nodes that affect completness and diversity:
...
def compositeNodesScores(explanation_strategy):
...
def granularity(explanation_strategy):
    ...
    composites = (explanation_strategy.numberCompositeNodes()/nodes) * 0.1
    questions = (explanation_strategy.numberQuestionNodes()/nodes) * 0.1
    
    
    return explainers + composites + questions + adj
